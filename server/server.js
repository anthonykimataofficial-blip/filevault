...
const previewSecurity = (req, res, next) => {
  res.setHeader(
    ...
    "frame-ancestors 'self' https://voolifilevault.com https://www.voolifilevault.com https://filevault-eight.vercel.app; sandbox allow-same-origin allow-scripts allow-modals allow-forms;"
  );
  next();
};
